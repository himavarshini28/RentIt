...
const ContactPage = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Contact Header */}
      <div className="bg-cyan-700 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="mt-2 text-base text-gray-500">
                <p>RentIt Headquarters</p>
                <p>123 PropertyLane</p>
            ...
            <div>
              ...
              <div className="mt-2 text-base text-gray-500">
                ...
                <p>Hours: Monday-Friday, 9AM-6PM PT</p>
              </div>
            </div>
            <div>
          ...
          <div className="bg-white shadow-md rounded-lg p-6 lg:col-span-2">
            {formStatus.submitted ? (
              <div className={`rounded-md ${formStatus.success ? 'bg-green-50' : 'bg-red-50'} p-4`}>
                <div className="flex">
      ...
      <div className="relative h-96 w-full">
        <div className="absolute inset-0 bg-gray-300">
          <iframe 
            ...
            marginWidth="0" 
            scrolling="no" 
            src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=San%20Francisco&ie=UTF8&t=&z=14&iwloc=B&output=embed"
